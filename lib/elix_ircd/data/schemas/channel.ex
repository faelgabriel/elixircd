defmodule ElixIRCd.Data.Schemas.Channel do
  ...
  defp validate_name(changeset) do
    ...
    cond do
      !String.starts_with?(name, "#") -> add_error(changeset, :name, "Channel name must start with a hash mark (#)")
      !Regex.match?(name_pattern, name) -> add_error(changeset, :name, "Invalid channel name format")
      true -> changeset
    end
  end
end
